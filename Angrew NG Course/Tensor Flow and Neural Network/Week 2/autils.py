...
plt.style.use(r"C:\Users\sarth\OneDrive\Documents\Machine Learning\Tensor Flow and Neural Network\deeplearning.mplstyle")


def load_data():
    X = np.load(r"C:\Users\sarth\OneDrive\Documents\Machine Learning\Tensor Flow and Neural Network\Week 2\X.npy")
    y = np.load(r"C:\Users\sarth\OneDrive\Documents\Machine Learning\Tensor Flow and Neural Network\Week 2\y.npy")
    return X, y
