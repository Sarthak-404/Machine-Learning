...
def load_data_multi():
    data = np.loadtxt(r"C:\Users\sarth\OneDrive\Documents\Machine Learning\houses.txt", delimiter=',')
    X = data[:,:2]
    y = data[:,2]
    return X, y
...
def load_house_data():
    data = np.loadtxt(r"C:\Users\sarth\OneDrive\Documents\Machine Learning\houses.txt", delimiter=',', skiprows=1)
    X = data[:,:4]
    y = data[:,4]
    return X, y
